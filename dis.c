...
int instructionSize(char opcode){
    switch(opcode){
	case 0x01
	case 0x11
	case 0x21
...
dis(char *store_output, char *lookaheadbuffer, unsigned char *chunk,
  ...
  // buffer -> process byte 2 -> store 2,3,4 -> use 2 and 3 (2 byte instruction)
